...
<div class="container-fluid">
	<div class="navbar-header">
				<s:url var="indexEN" namespace="/" action="changelanguageEdit">
			<s:param name="request_locale">en</s:param>
		</s:url>
		<s:a href="%{indexEN}">
				<img src="icon/angleterre.png" alt="English" />
			</s:a>
		<s:url var="indexFR" namespace="/" action="changelanguageEdit">
	...
	<div id="login">
		<h3 class="text-center text-white pt-5"><s:text name="global.edittitle" /></h3>
		<div class="container">
			<div id="login-row"
				...
				<div id="login-column" class="col-md-6">
					<div id="login-box" class="col-md-12">
						...
						<s:form id="login-form" class="form" action="save" method="post">
							<h3 class="text-center text-info"><s:text name="global.edittitle" /></h3>
							...
							<div class="form-group">
								...
								<s:textfield name="customer.city" key="Ville" id="login"
									class="form-control" theme="simple" min="2" maxlength="20" value="%{customer.city}"/>
							</div>
							...
							<div class="form-group">
								...
								<s:textfield name="customer.state" key="Etat" id="login"
									class="form-control" theme="simple" min="2" maxlength="2" value="%{customer.state}" 
							...
							<div class="form-group">
								...
								<s:submit type="button" name="submit"
									class="btn btn-secondary btn-lg" value="Confirm Edit"/>
							</div>
						</s:form>
