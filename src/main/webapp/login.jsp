...
<body>
<ul>
		<s:url var="indexEN" namespace="/" action="changelanguagelogin">
	...
	<div class="login">
		...
		<s:form action="login" method="post">
			<s:textfield name="compte.login" key="global.loginlabel"
				required="required" />
			<s:password name="compte.password" key="global.passwordlabel"
				required="required" />
			<s:submit type="button" class="btn btn-primary btn-block btn-large"
				key="global.loginbuttonlabel" />
		</s:form>
	</div>
	<script
